...
CProcessInfo *CProcessInfo::CreateInstance() { return new CProcessInfo(); }
...
void CProcessInfo::ResetVideoCodecInfo() {
    ...
    // 	CServiceBroker::GetDataCacheCore().SetVideoDimensions(m_videoWidth,
    // m_videoHeight);
...
bool CProcessInfo::AllowDTSHDDecode() { return true; }
