...
namespace TJS {
    ...
    static tTJSGlobalStringMap *TJSGlobalStringMap = nullptr;
    ...
    protected:
        ~tTJSGlobalStringMap() { TJSGlobalStringMap = nullptr; }
    ...
    //---------------------------------------------------------------------------
    void TJSAddRefGlobalStringMap() { tTJSGlobalStringMap::AddRef(); }

    //---------------------------------------------------------------------------
    void TJSReleaseGlobalStringMap() { tTJSGlobalStringMap::Release(); }
