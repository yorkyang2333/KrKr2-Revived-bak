...
namespace TJS {
    ...
    */
    tTJSLocalSymbolList::tTJSLocalSymbolList(tjs_int LocalCountStart) {
        ...
        StartWriteAddr = nullptr;
        CountWriteAddr = nullptr;
    }
    //---------------------------------------------------------------------------
    tTJSLocalSymbolList::~tTJSLocalSymbolList() {
        if(StartWriteAddr) {
...
*/
    ...
    //---------------------------------------------------------------------------
    tTJSLocalNamespace::tTJSLocalNamespace() {
        MaxCount = 0;
        CurrentCount = 0;
        MaxCountWriteAddr = nullptr;
    }
    //---------------------------------------------------------------------------
    tTJSLocalNamespace::~tTJSLocalNamespace() {
    ...
    //---------------------------------------------------------------------------
    tjs_int tTJSLocalNamespace::GetCount() {
        tjs_int count = 0;
        size_t i;
    ...
    //---------------------------------------------------------------------------
    tjs_int tTJSLocalNamespace::GetLevel() {
