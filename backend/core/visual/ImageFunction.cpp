...
tTJSNC_ImageFunction::tTJSNC_ImageFunction() :
    inherited(TJS_W("ImageFunction")){
        ...
        TJS_DECL_EMPTY_FINALIZE_METHOD
            ...
            TJS_BEGIN_NATIVE_CONSTRUCTOR_DECL(
                /*var.name*/ _this, /*var.type*/ tTJSNI_ImageFunction,
                /*TJS class name*/ ImageFunction){ return TJS_S_OK;
}
...
TJS_BEGIN_NATIVE_METHOD_DECL(/*func. name*/ operateAffine) {
    ...
    // srcrect=nullptr, cliprect=nullptr, affine=true,
...
TJS_BEGIN_NATIVE_METHOD_DECL(/*func. name*/ operateRect) {
    // dst, dleft, dtop, src, srect=nullptr, cliprect=nullptr
...
TJS_BEGIN_NATIVE_METHOD_DECL(/*func. name*/ operateStretch) {
    // dst, src, dstrect=nullptr, srcrect=nullptr, cliprect=nullptr
    // mode=omAlpha, face=dfAlpha, opa=255, type=0, hda=false
...
TJS_BEGIN_NATIVE_METHOD_DECL(/*func. name*/ doBoxBlur) {
    // bmp, xblur=1, yblur=1, clipRect=nullptr, isalpha=true
    if(numparams < 1)
        return TJS_E_BADPARAMCOUNT;
    tTJSNI_Bitmap *dst = nullptr;
    tTJSVariantClosure clo = param[0]->AsObjectClosureNoAddRef();
...
TJS_BEGIN_NATIVE_METHOD_DECL(/*func. name*/ fillRect) {
    // bmp, value, rect=nullptr, isalpha=true, cliprect=nullptr
    if(numparams < 2)
        return TJS_E_BADPARAMCOUNT;
