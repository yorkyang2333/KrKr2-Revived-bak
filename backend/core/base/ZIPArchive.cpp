...
// minizip-ng compatibility layer
typedef zlib_filefunc64_def zlib_filefunc64_32_def;
// minizip-ng renamed offset_curfile to disk_offset
#define offset_curfile disk_offset
// minizip-ng renamed dosDate to mz_dos_date (via macro)
#ifndef dosDate
#define dosDate mz_dos_date
#endif
...
/* unz_file_info64 is already defined by minizip-ng's unzip.h
   We use minizip-ng's definition directly. */
