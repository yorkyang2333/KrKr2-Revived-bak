...
public:
    ...
    struct DrawInfo {
        ...
        DrawInfo(REAL ox, REAL oy, Brush *brush) :
...
protected:
     ...
     * LineCapの取得
     */
    bool getLineCap(tTJSVariant &in, LineCap &cap, CustomLineCap *&custom,
                    REAL pw);
...
protected:
     ...
     * @param path 描画内容
     */
    void draw(Graphics *graphics, const Pen *pen, const Matrix *matrix,
     ...
     * @param path 描画内容
     */
    void fill(Graphics *graphics, const Brush *brush, const Matrix *matrix,
              const GraphicsPath *path);
     ...
     * @param glyph 描画するグリフ
     */
    void getGlyphOutline(const FontInfo *font, PointF &offset,
     ...
     * @param text 描画するテキスト
     */
    void getTextOutline(const FontInfo *font, PointF &offset,
...
public:
     ...
     * @return 更新領域情報
     */
    RectF drawArc(const Appearance *app, REAL x, REAL y, REAL width,
     ...
     * @return 更新領域情報
     */
    RectF drawPie(const Appearance *app, REAL x, REAL y, REAL width,
                  REAL height, REAL startAngle, REAL sweepAngle);
     ...
     * @return 更新領域情報
     */
    RectF drawBezier(const Appearance *app, REAL x1, REAL y1, REAL x2, REAL y2,
     ...
     * @return 更新領域情報
     */
    RectF drawEllipse(const Appearance *app, REAL x, REAL y, REAL width,
                      REAL height);
     ...
     * @return 更新領域情報
     */
    RectF drawRectangle(const Appearance *app, REAL x, REAL y, REAL width,
                        REAL height);
     ...
     * @return 更新領域情報
     */
    RectF drawPathString(const FontInfo *font, const Appearance *app, REAL x,
     ...
     * @return 更新領域情報
     */
    RectF drawPathString2(const FontInfo *font, const Appearance *app, REAL x,
                          REAL y, const tjs_char *text);
     ...
     * @return 更新領域情報
     */
    RectF drawString(const FontInfo *font, const Appearance *app, REAL x,
                     REAL y, const tjs_char *text);
     ...
     * @return 更新領域情報
     */
    RectF drawImageRect(REAL dleft, REAL dtop, Image *src, REAL sleft,
     ...
     * @return 更新領域情報
     */
    RectF drawImageStretch(REAL dleft, REAL dtop, REAL dwidth, REAL dheight,
                           Image *src, REAL sleft, REAL stop, REAL swidth,
                           REAL sheight);
     ...
     * @return 更新領域情報
     */
    RectF drawImageAffine(Image *src, REAL sleft, REAL stop, REAL swidth,
                          REAL sheight, bool affine, REAL A, REAL B, REAL C,
...
public:
     ...
     */
    bool getRecord() { return metafile != NULL; }
